...
public abstract class EnemyShipBuilding {
	...
	// When call to a new EnemyShip is made. The specific parts are based on the String entered. After the ship 
	// is made we execute multiple methods in the EnemyShip Object
